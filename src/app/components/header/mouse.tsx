export default function Mouse() {
    return (
        <>
            ...
            <div className="absolute inline-block left-1/2 -bottom-3.5 -translate-x-1/2 -rotate-45 p-1.5 shadow-[3px_-3px_0_0_#a330c9_inset] rounded-sm animate-[mouse-scroll-down_3s_infinite]"></div>
        </>
    );
}
